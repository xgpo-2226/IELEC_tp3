...
HD_PWD='/homes/g24obuzo/Documents/UEF_Integrated_Electronics/TP2_Sobel/sobel/sobel.runs/clk_wiz_vga_25MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_vga_25MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_vga_25MHz.tcl
