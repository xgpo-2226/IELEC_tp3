...
HD_PWD='/homes/g24obuzo/Documents/UEF_Integrated_Electronics/TP3_Filtres/IELEC_tp3/Reverb/proj/reverb/reverb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_adrgenUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_adrgenUnit.tcl
